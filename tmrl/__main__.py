...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--install", action="store_true", help="checks TMRL installation"
    )
    ...
    parser.add_argument(
        "--worker", action="store_true", help="launches a rollout worker"
    )
    parser.add_argument(
        "--expert",
        action="store_true",
        help="launches an expert rollout worker (no model update)",
    )
    parser.add_argument(
        "--test", action="store_true", help="runs inference without training"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        dest="wandb",
        action="store_true",
        help="(use with --trainer) if you want to log results on Weights and Biases, use this option",
    )
    parser.add_argument(
        "-d",
        "--config",
