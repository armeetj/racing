    ...
    class WindowInterface:
        def __init__(self, window_name):
            ...
            try:
                ...
                logging.error(
                    f"get_window_id failed, is xdotool correctly installed? {str(e)}"
                )
                self.window_id = None
        ...
        def move_and_resize(self, x=0, y=0, w=cfg.WINDOW_WIDTH, h=cfg.WINDOW_HEIGHT):
            ...
            try:
                ...
                c_resize = (
                    f"xdotool windowsize {str(self.window_id)} {str(w)} {str(h)}\n"
                )
                ...
                logging.debug(
                    f"success, let me nap 1s to make sure everything computed"
                )
                time.sleep(1)
